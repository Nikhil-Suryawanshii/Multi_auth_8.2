    ...
    <nav class="navbar navbar-expand">
        ...
        <div class="user-box dropdown">
            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret"
                href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="{{ (!empty($staffData->photo)) ? url('upload/staff_upload/',$staffData->photo):url('upload/No_Image_Available.jpg')}}"
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li><a class="dropdown-item" href="{{ route('staff.change.password') }}"><i class="bx bx-cog"></i><span>Change Password</span></a>
                </li>
                <li><a class="dropdown-item" href="javascript:;"><i
                ...
                <li><a class="dropdown-item" href="{{ route("staff.destroy") }}"><i
