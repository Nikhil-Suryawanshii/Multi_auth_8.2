<div class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="{{ route('student.create') }}"><i class="bx bx-right-arrow-alt"></i>Add Student</a>
                </li>
                {{-- <li> <a href="{{ route('student.edit') }}"><i class="bx bx-right-arrow-alt"></i>Edit Student</a>
                </li> --}}
                <li> <a href="{{route('student.list')}}"><i class="bx bx-right-arrow-alt"></i>List Student</a>
                </li>       
            </ul>
        </li>
           ...
           <li>
            ...
            <ul>
                <li> <a href="{{ route('customer.create') }}"><i class="bx bx-right-arrow-alt"></i>Add Customer</a>
                </li>
                {{-- <li> <a href="app-chat-box.html"><i class="bx bx-right-arrow-alt"></i>Edit Customer</a> --}}
                </li>
                <li> <a href="{{ route('customer.list') }}"><i class="bx bx-right-arrow-alt"></i>List Customer</a>
                </li>
           ...
           <li>
            ...
            <ul>
                ...
                {{-- <li> <a href="app-chat-box.html"><i class="bx bx-right-arrow-alt"></i>Edit Employee</a> --}}
                </li>
                <li> <a href="{{ route('employee.list') }}"><i class="bx bx-right-arrow-alt"></i>List Employee</a>
                </li>
