<div class="topbar d-flex align-items-center">
    <nav class="navbar navbar-expand">
        ...
        @php
                $id = Auth::user()->id;
                $brokerData = App\Models\User::find($id);
        @endphp

        <div class="user-box dropdown">
            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret"
                href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="{{ (!empty($brokerData->photo)) ? url('upload/broker_upload/',$brokerData->photo):url('upload/No_Image_Available.jpg')}}"
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item" href="{{ route('broker.profile') }}"><i
                ...
                <li><a class="dropdown-item" href="{{ route('broker.change.password') }}"><i class="bx bx-cog"></i><span>Change Password</span></a>
                </li>
                <li><a class="dropdown-item" href="javascript:;"><i
                ...
                <li><a class="dropdown-item" href="{{ route("broker.destroy") }}"><i
